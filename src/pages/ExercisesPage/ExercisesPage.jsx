  ...
  return (
    <div className="bg-gray-50 flex flex-col items-center justify-center p-6" style={{ width: "100%", minHeight: "60vh" }} >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
        ...
        >
          <h2 className="text-2xl font-semibold text-gray-700">Inaccessible eCommerce</h2>
        ...
        >
         ...
         <Link
          ...
          className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow w-full"
        >
          <h2 className="text-2xl font-semibold text-gray-700">Overlay Accessibility</h2>
          <p className="text-gray-600 mt-2">Improved overlay components with accessibility in mind</p>
        </Link>
        <Link
        ...
        >
         ...
         <Link
          ...
          className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow w-full"
        >
          <h2 className="text-2xl font-semibold text-gray-700">Completely Accessible eCommerce</h2>
          <p className="text-gray-600 mt-2">E-commerce page fully accessible</p>
        </Link>
      </div>
    </div>
  );
