...
const workshopCards = [
  ...
  {
    title: "Ex 3: Modal with focus trap",
...
export default function LandingPage() {
  return (
    <main className="container mx-auto px-6 py-8 space-y-10">
      <header>
        <h1 className="text-3xl md:text-4xl font-extrabold mb-8 drop-shadow-md text-[#23A278]"> Accessibility from Day One: React Development Done Right
        </h1>
      </header>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <p className="text-lg font-light">
              Join us at <strong className="text-[#23A278]">React India</strong>, for a hands-on workshop on{" "}
              <strong className="text-[#23A278]">Accessibility to make web pages Build for Everyone. Build with Accessibility.</strong>.
      ...
      <section className="flex flex-col md:flex-row gap-8 justify-center items-start">
        ...
        >
          <h2 id="presenters-heading" className="text-xl font-semibold mb-6 text-center text-[#23A278]">
            Presenters:
          </h2>
