...
const SearchAndFilter = ({ onSearchChange, onFilterChange }) => {
  ...
  return (
    <div className="mb-8">
      <h2 id="search-filter-heading" className="sr-only">Search and Filter Options</h2>
        ...
        <div className="relative" ref={filterRef}>
          ...
          >
            <span className="flex items-center">
              ...
              Filters
              <svg className={`ml-2 h-5 w-5 transform ${isFilterOpen ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          {isFilterOpen && (
            ...
            >
              <div className="p-4">
                <h3 id="filter-heading" className="font-medium text-gray-900 mb-4">Filter Products</h3>
